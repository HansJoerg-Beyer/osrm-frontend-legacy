...
OSRM.Routing = {
  ...
  getRoute_Reversed: function() {
    ...
    OSRM.JSONP.clear('redraw');
    OSRM.JSONP.clear('route');
    OSRM.JSONP.call(OSRM.Routing._buildCall()+'?steps=true', OSRM.Routing.showRoute, OSRM.Routing.timeoutRoute_Reversed, OSRM.DEFAULTS.JSONP_TIMEOUT, 'route', {});
  },
  ...
  getRoute_Redraw: function(parameters) {
    ...
    OSRM.JSONP.clear('dragging');
    OSRM.JSONP.clear('redraw');
    OSRM.JSONP.call(OSRM.Routing._buildCall()+'?steps=true', OSRM.Routing.showRoute_Redraw, OSRM.Routing.timeoutRoute, OSRM.DEFAULTS.JSONP_TIMEOUT, 'redraw',parameters);
  },
